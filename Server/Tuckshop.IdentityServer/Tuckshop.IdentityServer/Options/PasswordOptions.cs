namespace Tuckshop.IdentityServer.Options
{
  using Neo.Options;

  /// <summary>
  /// Options class for Passwords.
  /// </summary>
  [ConfigSectionName("Passwords")]
  public class PasswordOptions : ValidateableOptions<PasswordOptions>
  {
    /// <summary>
    /// Gets or sets the minimum length a password must be. Defaults to 8 for development purposes, recommended 16 for secure applications.
    /// </summary>
