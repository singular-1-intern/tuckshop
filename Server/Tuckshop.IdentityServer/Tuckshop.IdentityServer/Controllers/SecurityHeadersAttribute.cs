namespace Tuckshop.IdentityServer.Controllers
{
  ...
  /// <summary>
  /// Attribute for adding the required security headers onto the API endpoints
  /// Full details still need to be worked out, this code originally came from the Neo.IdentityServer.Controllers.Consent
  /// see https://github.com/IdentityServer/Neo.IdentityServer.Controllers.Consent.
  /// </summary>
